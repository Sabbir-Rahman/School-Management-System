...
<div id="container">
    <br><br>
    <h3><font color="white">Student Financial View</font></h3>
    @if(count($errors)>0)
    ...
    <table id="datatable" class="table table-dark table-striped">
        ...
        @foreach($students as $student)
            <tr>
                ...
                <td scope="row">{{$student['fatherOccupation']}}</td>
                <td scope="row">{{$student['fatherIncome']}}</td>
                <td scope="row">{{$student['motherOccupation']}}</td>
                <td scope="row">{{$student['motherIncome']}}</td>
