...
<div id="container">
    <br><br>
    <h3><font color="white">Student General View</font></h3>
    @if(count($errors)>0)
...
<!-- Button trigger modal -->
    ...
    <table id="datatable" class="table table-dark table-striped">
        ...
        <th scope="col">Student Section ID</th>
        <th scope="col">Student Contact(Father)</th>
        </thead>
        <tbody>
        @foreach($students as $student)
            <tr>
                ...
                <td scope="row">{{$student['student_blood_group']}}</td>
                <td scope="row">{{$student['student_address']}}</td>
                <td scope="row">{{$student['student_class']}}</td>
                <td scope="row">{{$student['student_section']}}</td>
